...
## 下载跨地域已备份文件
在目标地域， 如日本（东京）的实例设置跨地域备份到韩国（首尔）， 可以在韩国（首尔）的跨地域备份列表页查看已经备份的文件。 点击下载按钮后， 会返回文件的公网下载地址。
![image](/images/cross_backup_7.png)

## 从跨地域备份文件创建实例
在目标地域， 如日本（东京）的实例设置跨地域备份到韩国（首尔）， 可以在韩国（首尔）的跨地域备份列表页查看已经备份的文件。 点击从备份创建， 可以从备份创建一个新的实例， 需注意
